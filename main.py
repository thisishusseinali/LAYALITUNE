...
dpg.create_context()
dpg.create_viewport(title="LayaliTune",large_icon="icon.svg",small_icon="icon.svg")
pygame.mixer.init()
global state
state=None
...
with dpg.theme(tag="base"):
	with dpg.theme_component():
		...
		dpg.add_theme_color(dpg.mvThemeCol_ButtonActive, (250,0,0,99))
		dpg.add_theme_color(dpg.mvThemeCol_ButtonHovered, (250,0,0,99))
...
with dpg.theme(tag="slider_thin"):
	with dpg.theme_component():
		dpg.add_theme_color(dpg.mvThemeCol_FrameBgActive, (250,0,0,99))
		dpg.add_theme_color(dpg.mvThemeCol_FrameBgHovered,(250,0,0,99))
		dpg.add_theme_color(dpg.mvThemeCol_SliderGrabActive, (250,0,0,99))
		dpg.add_theme_color(dpg.mvThemeCol_SliderGrab, (250,250,250))
		dpg.add_theme_color(dpg.mvThemeCol_FrameBg,(250,0,0,99))
...
with dpg.window(tag="main",label="window title"):
	...
	with dpg.group(horizontal=True):
		with dpg.child_window(width=200,tag="sidebar"):
			dpg.add_text("LayaliTune Musicart",color=(250,0,0))
			dpg.add_text("Build by HUSSEIN ALI")
			dpg.add_spacer(height=2)
			dpg.add_button(label="Support",width=-1,height=23,callback=lambda:webbrowser.open(url="https://github.com/thisishusseinali"))
